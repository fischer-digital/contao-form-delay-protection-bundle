...
$GLOBALS['TL_LANG']['tl_form']['enableSilentDrop']                = ['Spam stillschweigend verwerfen (Silent Drop)', 'Zeigt bei erkanntem Spam (Regex-Treffer oder Absenden in unter 3 Sekunden) normal die Erfolgsmeldung an, versendet und speichert die Daten aber nicht. So erhalten Bots keine Rückmeldung darüber, dass sie aufgeflogen sind. Jede Verwerfung wird im System-Protokoll vermerkt.'];
