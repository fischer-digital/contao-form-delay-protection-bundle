...
$GLOBALS['TL_LANG']['tl_form']['enableSilentDrop']                = ['Silently drop spam', 'Shows the regular success message when spam is detected (regex match or submission within less than 3 seconds), but does not send or store the data. This way bots do not get any feedback that they have been detected. Every drop is recorded in the system log.'];
