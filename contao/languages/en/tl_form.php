...
$GLOBALS['TL_LANG']['tl_form']['enableRegexSpamProtection']        = ['Enable regex spam protection', 'Checks the input for typical spam patterns: (1) five or more consecutive consonants such as "xjkrtw" (single-line text fields only), (2) unusual upper/lowercase mixing within a word such as "aggZJZAK" and (3) the Gmail dot trick with three or more dots before @gmail.com.'];
